...
<head>
    ...
    <link href="<?php echo base_url('assets/css/docs2.css'); ?>" rel="stylesheet">
...
<div class="row">
    <div class="container">
        <ul class="nav nav-pills nav-stacked col-lg-2">
            <li><a href="<?php echo base_url('compeny'); ?>"><i class="icon-th-large"></i><span> ข้อมูลบริษัท</span></a></li>
            <li><a href="<?php echo base_url('project'); ?>"><i class="icon-list-alt"></i><span> ข้อมูลโครงการ</span></a></li>
            <li><a href="<?php echo base_url('boq'); ?>" ><i class="icon-tasks"></i><span> BOQ</span></a></li>
            <li><a href="<?php echo base_url('store'); ?>"><i class="icon-picture"></i><span> คลังสินค้า</span></a></li>
            <li><a href="<?php echo base_url('employee'); ?>"><i class="icon-th"></i><span> ข้อมูลพนักงาน</span></a></li>
            <li><a href="<?php echo base_url(); ?>"><i class="icon-align-center"></i><span> ตัวแทนจำหน่าย</span></a></li>
        </ul>
        <div id="content" class="col-lg-10 section-body">
